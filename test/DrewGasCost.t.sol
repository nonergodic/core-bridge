...
import { Wormhole } from "core-bridge/drew/Wormhole.sol";
import { Setup } from "core-bridge/drew/Setup.sol";
import { Implementation } from "core-bridge/drew/Implementation.sol";

contract DrewGasCost is ManualSigning {

  Implementation private _drewCore;
  ...
  function testDrewOptimizations() public view {
    (, bool success, string memory reason) =
      _drewCore.parseAndVerifyVMOptimized(_vaa, _encodedGuardianSet, 0);
